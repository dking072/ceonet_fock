"""
Verbatim copy of cace/modules/tensornet_utils.py, vendored here so
ceonet_fock does not depend on cace's internals (and so we can freely
extend tensornet.py with a radial TP variant).
"""
